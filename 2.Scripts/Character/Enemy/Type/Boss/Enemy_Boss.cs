...
public class Enemy_Boss : Enemy
{
    ...
    {
        bool playerWithinDistance = Vector3.Distance(transform.position, player.transform.position) < minAbilityDistance;
    ...
    private void MassDamage(Vector3 impactPoint, float impactRadius,int damage)
    {
        ...
        foreach (Collider hit in colliders)
        {
            ...
            if (damagable != null)
            {
                ...
                AudioManager.instance?.PlayAudio(SoundType.EnemyJumpImpact);
            }
