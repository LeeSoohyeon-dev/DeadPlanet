...
public class Enemy_Melee : Enemy
{
    ...
    private bool hasSpeedPenaltyApplied;
    ...
    protected override void Awake()
    {
        ...
        deadState = new DeadState(this, stateMachine, "isIdle");
    }
    ...
    public override void AbilityTrigger()
    {
        ...
        if (hasSpeedPenaltyApplied == false)
        {
            hasSpeedPenaltyApplied = true;
    ...
    {
        Enemy_WeaponModel newWeapon =
            visuals.currentWeaponModel != null ? visuals.currentWeaponModel.GetComponent<Enemy_WeaponModel>() : null;
