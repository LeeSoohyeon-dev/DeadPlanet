...
public class UI_Start : MonoBehaviour
{
    ...
    private void UpdateLoadingProgress()
    {
        ...
        // allowSceneActivation=false 동안 progress가 끝까지 도달하지 않는 유니티 동작을 0~1로 정규화
        ...
        if (progressText != null && percent != lastDisplayedPercent)
        {
    ...
    private void OnTouchAreaClicked()
    {
        ...
        GameEvents.RaisePlaySound(SoundType.Click);
        DisableTouchArea();
        HideUIElements();
