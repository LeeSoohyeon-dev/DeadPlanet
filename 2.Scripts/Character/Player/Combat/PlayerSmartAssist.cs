...
public class PlayerSmartAssist : MonoBehaviour
{
    ...
    private Transform FindBestTarget()
    {
        ...
        int hitCount = Physics.OverlapSphereNonAlloc(playerPos, assistRange, overlapBuffer, enemyLayerMask);
    ...
    private Vector3 GetDirectionToTarget()
    {
        ...
        if (useGunPointForRotation && player != null && player.weaponController != null)
        {
            gunPoint = player.weaponController.GunPoint();
        }
        if (gunPoint != null)
        {
